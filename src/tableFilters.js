...
async function setFilters() {
    ...
    createFilterGroup(["HP", "Attack", "Defenese", "SpAttack", "SpDefense", "Speed", "BST"], "Base Stats", [speciesFilterList, locationsFilterList], true);
}
...
function deleteFiltersFromTable() {
    ...
    while (tableFilterContainer.firstChild) tableFilterContainer.removeChild(tableFilterContainer.firstChild);
}
