async function createSpeciesPanel(name) {
    ...
    if (speciesType1.innerText === speciesType2.innerText) speciesType2.classList.add("hide");
    ...
    while (speciesEggGroups.firstChild) speciesEggGroups.removeChild(speciesEggGroups.firstChild);
    while (speciesHeldItems.firstChild) speciesHeldItems.removeChild(speciesHeldItems.firstChild);
    while (speciesChanges.firstChild) speciesChanges.removeChild(speciesChanges.firstChild);
    ...
    if (species[name]["eggGroup1"] !== species[name]["eggGroup2"]) speciesEggGroups.append(eggGroup2);
    ...
    if (speciesHeldItems.firstChild) speciesHeldItemsContainer.classList.remove("hide");
    else speciesHeldItemsContainer.classList.add("hide");
    ...
    if (speciesChanges.firstChild) speciesChangesContainer.classList.remove("hide");
    else speciesChangesContainer.classList.add("hide");

    while (speciesDefensiveTypeChart.firstChild) speciesDefensiveTypeChart.removeChild(speciesDefensiveTypeChart.firstChild);
    ...
    while (recommendedCoverage.children.length > 0) recommendedCoverage.removeChild(recommendedCoverage.firstChild);
    ...
    while (speciesOffensiveTypeChart.firstChild) speciesOffensiveTypeChart.removeChild(speciesOffensiveTypeChart.firstChild);
        ...
        if (value) {
            for (let i = 0; i < value.length; i++) {
                if (value[i] > 0) {
                    ...
                    else if(i === 1) miscValue.innerText += `${value[i]} Attack`;
                    else if(i === 2) miscValue.innerText += `${value[i]} Defense`;
                    else if(i === 3) miscValue.innerText += `${value[i]} SpAttack`;
                    else if(i === 4) miscValue.innerText += `${value[i]} SpDefense`;
                    else if(i === 5) miscValue.innerText += `${value[i]} Speed`;
                }
            }
        } else {
