...
headerAbilitiesName.addEventListener("click", () => {
    if (headerAbilitiesName.classList.contains("th-sort-desc")) sortTableByClassName(abilitiesTable, abilities, ["name"], "ability", asc = true);
    else sortTableByClassName(abilitiesTable, abilities, ["name"], "ability", asc = false);
});
headerAbilitiesDescription.addEventListener("click", () => {
    if (headerAbilitiesDescription.classList.contains("th-sort-desc")) sortTableByClassName(abilitiesTable, abilities, ["description"], "description", asc = true);
    else sortTableByClassName(abilitiesTable, abilities, ["description"], "description", asc = false);
});

headerMovesMove.addEventListener("click", () => {
    if (headerMovesMove.classList.contains("th-sort-desc")) sortTableByClassName(movesTable, moves, ["name"], "move", asc = true);
    else sortTableByClassName(movesTable, moves, ["name"], "move", asc = false);
});
headerMovesType.addEventListener("click", () => {
    if (headerMovesType.classList.contains("th-sort-desc")) sortTableByClassName(movesTable, moves, ["type", "split"], "type", asc = true);
    else sortTableByClassName(movesTable, moves, ["type", "split"], "type", asc = false);
});
headerMovesSplit.addEventListener("click", () => {
    if (headerMovesSplit.classList.contains("th-sort-desc")) sortTableByClassName(movesTable, moves, ["split", "type"], "split", asc = true);
    else sortTableByClassName(movesTable, moves, ["split", "type"], "split", asc = false);
});
headerMovesPower.addEventListener("click", () => {
    if (headerMovesPower.classList.contains("th-sort-desc")) sortTableByClassName(movesTable, moves, ["power"], "power", asc = true);
    else sortTableByClassName(movesTable, moves, ["power"], "power", asc = false);
});
headerMovesAccuracy.addEventListener("click", () => {
    if (headerMovesAccuracy.classList.contains("th-sort-desc")) sortTableByClassName(movesTable, moves, ["accuracy"], "accuracy", asc = true);
    else sortTableByClassName(movesTable, moves, ["accuracy"], "accuracy", asc = false);
});
headerMovesPP.addEventListener("click", () => {
    if (headerMovesPP.classList.contains("th-sort-desc")) sortTableByClassName(movesTable, moves, ["PP"], "PP", asc = true);
    else sortTableByClassName(movesTable, moves, ["PP"], "PP", asc = false);
});
headerMovesEffect.addEventListener("click", () => {
    if (headerMovesEffect.classList.contains("th-sort-desc")) sortTableByClassName(movesTable, moves, ["effect"], "effect", asc = true);
    else sortTableByClassName(movesTable, moves, ["effect"], "effect", asc = false);
});

headerSpeciesID.addEventListener("click", () => {
    if (headerSpeciesID.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["ID"], "ID", asc = true);
    else sortTableByClassName(speciesTable, species, ["ID"], "ID", asc = false);
});
...
headerSpeciesName.addEventListener("click", () => {
    if (headerSpeciesName.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["name"], "species", asc = true);
    else sortTableByClassName(speciesTable, species, ["name"], "species", asc = false);
});
headerSpeciesTypes.addEventListener("click", () => {
    if (headerSpeciesTypes.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["type1", "type2"], "types", asc = true);
    else sortTableByClassName(speciesTable, species, ["type1", "type2"], "types", asc = false);
});
headerSpeciesAbilities.addEventListener("click", () => {
    if (headerSpeciesAbilities.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["abilities"], "abilities", asc = true);
    else sortTableByClassName(speciesTable, species, ["abilities"], "abilities", asc = false);
});
headerSpeciesInnates.addEventListener("click", () => {
    if (headerSpeciesInnates.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["innates"], "innates", asc = true);
    else sortTableByClassName(speciesTable, species, ["innates"], "innates", asc = false);
});
headerSpeciesHP.addEventListener("click", () => {
    if (headerSpeciesHP.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["baseHP"], "baseHP", asc = true);
    else sortTableByClassName(speciesTable, species, ["baseHP"], "baseHP", asc = false);
});
headerSpeciesAttack.addEventListener("click", () => {
    if (headerSpeciesAttack.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["baseAttack"], "baseAttack", asc = true);
    else sortTableByClassName(speciesTable, species, ["baseAttack"], "baseAttack", asc = false);
});
headerSpeciesDefense.addEventListener("click", () => {
    if (headerSpeciesDefense.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["baseDefense"], "baseDefense", asc = true);
    else sortTableByClassName(speciesTable, species, ["baseDefense"], "baseDefense", asc = false);
});
headerSpeciesSpAttack.addEventListener("click", () => {
    if (headerSpeciesSpA.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["baseSpAttack"], "baseSpAttack", asc = true);
    else sortTableByClassName(speciesTable, species, ["baseSpAttack"], "baseSpAttack", asc = false);
});
headerSpeciesSpDefense.addEventListener("click", () => {
    if (headerSpeciesSpDefense.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["baseSpDefense"], "baseSpDefense", asc = true);
    else sortTableByClassName(speciesTable, species, ["baseSpDefense"], "baseSpDefense", asc = false);
});
headerSpeciesSpeed.addEventListener("click", () => {
    if (headerSpeciesSpeed.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["baseSpeed"], "baseSpeed", asc = true);
    else sortTableByClassName(speciesTable, species, ["baseSpeed"], "baseSpeed", asc = false);
});
headerSpeciesBST.addEventListener("click", () => {
    if (headerSpeciesBST.classList.contains("th-sort-desc")) sortTableByClassName(speciesTable, species, ["BST"], "BST", asc = true);
    else sortTableByClassName(speciesTable, species, ["BST"], "BST", asc = false);
});
